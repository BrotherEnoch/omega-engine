...
//! Confidence decay function — §15.2
//!
//! Formula: base × exp(−0.0001 × age_ms)
//! Half-life ≈ 6.93 seconds.  Effectively zero after ~100 seconds.

/// §15.2 — Exponential confidence decay.
///
/// At age 1 s  (1 000 ms):  base × 0.905
/// At age 10 s (10 000 ms): base × 0.368
/// At age 1 m  (60 000 ms): base × 0.002
#[inline]
