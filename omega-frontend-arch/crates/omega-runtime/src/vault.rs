// omega-frontend-arch/crates/omega-runtime/src/vault.rs — L13 Vault
// Manages capital custody. Heartbeat every 2s — conservative, state-critical.
// Depends on: L03 Risk, L04 Security being healthy.
...
pub const LAYER_ID: &str = "L13";

const DEPS: &[&str] = &["L03", "L04"];
        ...
        loop {
            ...
            if !deps_ok {
                registry.update_layer(
                    ...
                    "waiting for L03 Risk / L04 Security",
                );
