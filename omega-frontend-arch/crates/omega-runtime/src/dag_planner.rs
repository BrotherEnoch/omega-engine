// omega-frontend-arch/crates/omega-runtime/src/dag_planner.rs — L06 DAG Planner
// Plans execution graphs for strategy bundles. Heartbeat every 1s.
// Depends on: L01 External Data, L02 EIL, L03 Risk being healthy.
...
pub const LAYER_ID: &str = "L06";

const DEPS: &[&str] = &["L01", "L02", "L03"];
