...
// â”€â”€â”€ Spec constants (never change without a governance vote) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Prover tier â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Prover tier identifier (spec: "t1_software" baseline).
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum ProverTierConfig {
    /// In-process Winterfell STARK (spec baseline, Phase 1â€“2).
    T1Software,
...
impl Default for ProverTierConfig {
    fn default() -> Self { ProverTierConfig::T1Software }
}

// â”€â”€â”€ Full ZK configuration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
impl ZkConfig {
    ...
    pub fn sla_ms(&self, is_microtx: bool) -> u64 {
        if is_microtx { self.microtx_sla_ms } else { self.normal_sla_ms }
    }
}
