...
fn encode_aave_v3(
    ...
    // slot 3: offset to params bytes (5 static words Ã— 32 = 160 = 0xa0)
...
fn encode_balancer(
    ...
    // slot 1: offset to tokens array  (4 head words Ã— 32 = 128)
...
fn encode_uniswap_v3(
    _pool:      Address,  // pool's own address â€” not encoded, used for routing upstream
    recipient:  Address,
    ...
    // offset to data (4 static words Ã— 32 = 128)
    buf.extend_from_slice(&u256_to_bytes32(U256::from(128u32)));
