...
//
// Event sampler â€” 100% sampling for LA events, configurable for others (Â§16).
//
// ## Spec Â§16
//
...
//
//   All other events use the configured `sample_rate` (0.0â€“1.0).
...
//
//   `Sampler` is `Clone` and `Send + Sync` â€” multiple exporter tasks
...
/// Event sampler enforcing Â§16 sampling policy.
///
...
impl Sampler {
    ...
    ///
    /// LA events (Â§16 always-sampled) always return `true`.
    ...
    pub fn should_emit(&self, event: &OmegaEvent) -> bool {
        ...
        // `Option<i64>`; we use 0 as fallback (safe â€” only affects bucket
        // placement, not correctness of the always-sampled path above).
        let nanos  = event.timestamp()
            .timestamp_nanos_opt()
            .unwrap_or(0)
            .unsigned_abs();
...
mod tests {
    ...
    // â”€â”€ Always-sampled LA events â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn la_events_always_pass_at_zero_rate() {
        ...
        assert!(
            ...
            "LA events must be always-sampled even at rate 0.0 (Â§16)"
        );
    }
    ...
    // â”€â”€ Non-LA events â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn non_la_at_zero_rate_always_rejected() {
        ...
        assert!(!any_passed, "non-LA events at rate 0.0 must always be rejected");
    }
    ...
    // â”€â”€ Approximate rate over many events â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Sample rate clamping â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Always-sampled variants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn emergency_halt_is_always_sampled() {
        ...
        assert!(
            ...
            "EmergencyHalt must be always-sampled (Â§16)"
        );
    }
    ...
    fn profit_split_is_always_sampled() {
        ...
        assert!(
            sampler.should_emit(&event),
            "ProfitSplit must be always-sampled (Â§16)"
        );
    }
