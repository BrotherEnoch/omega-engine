...
//! Relay configuration â€” deserialised from `config/default.toml` `[relay]` section.
//!
...
// â”€â”€ WebSocket rate limits (Â§17.1) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Relay config â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
pub enum RelayName {
    ...
    Titan,
    Eden,
    /// Escape hatch â€” any relay not in the enum above.
    #[serde(untagged)]
    Other(String),
}
...
pub struct RelayConfig {
    ...
    /// Max bundle submissions per relay per second â€” cascade backpressure (Â§11.2).
    pub max_bundles_per_relay_per_second: usize,

    /// Milliseconds to wait between successive bundle submissions â€” cascade stagger (Â§11.2).
    pub stagger_ms: u64,
}
...
pub struct GasWarRelayConfig {
    /// Path to `config/builder_blacklist.toml` (Â§12.3).
    pub builder_blacklist_path: String,
    /// Max priority fee gwei â€” Arbitrum ceiling (Â§12.2 / I3).
...
mod tests {
    ...
    fn relay_config_defaults_match_spec() {
        ...
        assert_eq!(cfg.max_bundles_per_relay_per_second, 4, "Â§11.2: max 4 bundles/relay/sec");
        assert_eq!(cfg.stagger_ms, 10, "Â§11.2: 10 ms stagger");
        assert!(cfg.blind_fallback);
    }

    #[test]
    fn ws_rate_limits_match_spec() {
        assert_eq!(WS_RATE_AUTHENTICATED, 300, "Â§17.1: 300/min authenticated");
        assert_eq!(WS_RATE_ANONYMOUS, 100, "Â§17.1: 100/min anonymous");
    }
