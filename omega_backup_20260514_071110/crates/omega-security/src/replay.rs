...
//
//   Certora C5 â€” Replay impossibility:
...
//
//   Both are append-only from the security layer's perspective â€” hashes and nonces
...
// â”€â”€â”€ Blueprint replay guard â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Chain-scoped key: (blueprint_hash[32], chain_id[8]) â†’ 40 bytes, used as DashSet key.
...
/// Set of executed blueprint hashes â€” prevents replay across sequencer restarts.
///
...
impl ReplayGuard {
    ...
    /// Returns `Ok(())` otherwise (does NOT insert â€” call `mark_executed` after
    ...
    pub fn check(&self, blueprint_hash: &[u8; 32], chain_id: u64) -> Result<(), SecurityError> {
        ...
        if self.executed.contains(&key) {
            ...
            tracing::error!(
                ...
                chain_id,
                "REPLAY DETECTED â€” blueprint already executed"
            );
...
// â”€â”€â”€ Nonce registry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
impl NonceRegistry {
    ...
    ///
    /// Does NOT advance the nonce â€” call `advance()` after successful on-chain inclusion.
    pub fn validate(
        &self,
        strategy_id:     &str,
        chain_id:        u64,
        ...
        match self.nonces.get(&key) {
            ...
            None => {
                // First blueprint for this (strategy, chain) â€” nonce must be 0.
...
mod replay_tests {
    ...
    // â”€â”€ ReplayGuard â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ NonceRegistry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
