...
//! OmegaEngine v12 integration layer â€” Â§2.1, Â§24
//!
//! Advisory structs for every v12 subsystem the PRL feeds into:
//!   Gas War Engine          â€” Â§13.3, v12 Â§12
//!   Liquidation Arb Engine  â€” Â§11.3, v12 Â§11
//!   Loss Attribution Engine â€” Â§14,   v12 Â§13
//!   Relay Routing           â€” Â§10,   v12 Â§11.2
//!   Sequencer Restart       â€” Â§12,   v12 Â§11.3
//!   Health FSM bridge       â€” Â§17,   v12 Â§3
//!
//! All advisories:
//!   - Return `None` when PRL is halted (Â§17.2)
//!   - Enforce minimum confidence thresholds (Â§15.3)
//!   - Never bypass governance caps (Â§13.3)
//!   - Are safe to ignore â€” execution continues unchanged

use tracing::{debug, warn};

use crate::{
    GasWarForecast, LiquidationPattern, MinConfidenceThresholds,
    PatternRecognitionLayer, SequencerRiskScore,
    health::degraded::PrlHealthState,
    metrics::events::ObservabilityEvent,
};

// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Gas War Engine advisory â€” Â§13, v12 Â§12
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Advisory for the Gas War Engine (Â§13.3).
#[derive(Debug, Clone)]
...
impl GasWarAdvisory {
    pub fn from_prl(prl: &PatternRecognitionLayer) -> Option<Self> {
        ...
        let bid_multiplier = (1.0 + forecast.escalation_velocity * 0.1)
            .clamp(0.8, 2.0);
        debug!(
        ...
        Some(Self { is_actionable: true, bid_multiplier, forecast })
    }
}

// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Liquidation Arb advisory â€” Â§11.3, v12 Â§11
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Advisory for the Liquidation Arbitrage Engine (Â§11.3).
#[derive(Debug, Clone)]
...
impl LiquidationAdvisory {
    pub fn for_position(
        ...
        debug!(position_key, urgency, elevate_priority = elevate,
            widen_relay_spread = widen, "LiquidationAdvisory derived");
        Some(Self { elevate_priority: elevate, widen_relay_spread: widen, urgency, pattern })
    }
}

// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Loss Attribution advisory â€” Â§14, v12 Â§13
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Advisory for the Loss Attribution Engine (Â§14.2).
#[derive(Debug, Clone)]
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Relay routing advisory â€” Â§10, v12 Â§11.2
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
impl RelayRoutingAdvisory {
            ...
            let trust = if let Some(score) = prl.get_relay_risk(id) {
                if score.is_leak_suspected() {
                    ...
                    prl.metrics.emit_always_sampled(
                        ...
                        Some(id),
                        "relay leak suspicion above 3Ïƒ threshold",
                    );
                }
                if score.trust_score < 0.20 {
                    deranked.push(id);
                    warn!(relay_id = id, trust = score.trust_score,
                        "PRL: relay deranked from top tie-band");
                }
                score.trust_score
            } else {
                0.5 // neutral â€” no PRL data yet
            };
    ...
    pub fn top_tie_band(&self, band_pct: f32) -> Vec<u32> {
        if self.ranked_relays.is_empty() { return Vec::new(); }
        let best = self.ranked_relays[0].1;
        self.ranked_relays.iter()
            .filter(|(id, score)| {
                *score >= best * (1.0 - band_pct)
                    && !self.deranked_relays.contains(id)
            })
            .map(|(id, _)| *id)
            .collect()
    }
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Sequencer restart advisory â€” Â§12, v12 Â§11.3
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Advisory for the v12 `SequencerRestartHandler` (Â§11.3) and `LaReorgGuard` (Â§11.4).
#[derive(Debug, Clone)]
...
impl SequencerRestartAdvisory {
    pub fn from_prl(prl: &PatternRecognitionLayer) -> Option<Self> {
        ...
        Some(Self { risk, activate_dedup, activate_reorg_guard })
    }
}
...
///
/// A HALTED PRL does NOT cascade into the v12 FSM â€” execution continues.
