...
//! Liquidation Opportunity Patterning â€” Â§11

/// Â§11.2 â€” Per-position liquidation risk signature.
#[derive(Debug, Clone)]
...
impl LiquidationPattern {
    ...
    /// Â§11.3 â€” Whether PRL recommends elevated recompute cadence (within governance limits).
    #[inline]
...
mod tests {
    ...
    fn urgency_in_bounds() {
        let lp = LiquidationPattern {
            position_key: 1, hf_velocity: 0.9,
            oracle_correlation: 0.8, gas_pressure: 0.5,
            competitor_density: 0.6, expected_profit_decay: 0.2,
            confidence: 0.9,
        };
    ...
    fn high_urgency_elevates_priority() {
        let lp = LiquidationPattern {
            position_key: 1, hf_velocity: 1.0,
            oracle_correlation: 1.0, gas_pressure: 1.0,
            competitor_density: 1.0, expected_profit_decay: 0.0,
            confidence: 0.95,
        };
