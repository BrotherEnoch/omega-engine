...
//
//   1. `competition_probability()` â€” probability that a competing bot wins [0.0, 1.0].
//      Drives check 11 (MISS_COMPETITION drop code).
//
//   2. `priority_fee_gwei()` â€” suggested priority fee in gwei for the Gas War Engine.
//      Drives adaptive gas cap (spec S12): 5 % of bonus_eth / 21_000 Ã— urgency Ã— win_rate.
//
// Asset tiers (spec: "Major/Mid/LongTail"):
//   Major    â€” WETH, WBTC: base competition = 85 %.
//   Mid      â€” LINK, UNI, AAVE, etc.: base = 60 %.
//   LongTail â€” everything else: base = 25 %.
//
// Health-factor urgency multipliers (spec S11):
//   HF < 1.001 â†’ 3.0Ã—   (imminent â€” every bot will fire)
//   HF < 1.005 â†’ 2.0Ã—
//   HF < 1.01  â†’ 1.5Ã—
//   HF â‰¥ 1.01  â†’ 1.0Ã—
//
...
//
// Priority fee urgency Ã— win_rate multipliers match the cascade_mode spec.
//
// Thread-safety: all functions are pure / stateless.

use serde::{Deserialize, Serialize};

// â”€â”€â”€ Asset tier â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

/// Asset tier classification (spec S11 competition model).
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub enum AssetTier {
    /// WETH, WBTC â€” base competition 85 %.
    Major,
    /// LINK, UNI, AAVE, CRV, etc. â€” base competition 60 %.
    Mid,
    /// Long-tail â€” base competition 25 %.
    LongTail,
}
...
// â”€â”€â”€ Competition probability â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/// Size multiplier â€” larger liquidations attract more bots (spec: log10 scaling).
...
///
/// # Arguments
/// * `asset_tier`          â€” asset classification
/// * `health_factor`       â€” current HF of the target position
/// * `liquidation_eth`     â€” estimated liquidation size in ETH
...
// â”€â”€â”€ Priority fee computation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
///
/// # Arguments
/// * `expected_bonus_eth`  â€” expected liquidation bonus in ETH
/// * `health_factor`       â€” current HF
/// * `historical_win_rate` â€” rolling 30-day win rate for this strategy/asset
...
mod competition_tests {
    ...
    // â”€â”€ AssetTier::from_symbol â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ competition_probability â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    #[test]
    fn major_asset_imminent_hf_high_probability() {
        let p = competition_probability(AssetTier::Major, 1.0005, 50.0);
        // base 0.85 Ã— urgency 1.5 Ã— size > 1 â†’ capped at 0.99
    ...
    // â”€â”€ priority_fee_gwei â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    #[test]
    fn fee_floor_at_2_gwei() {
        // Zero bonus â†’ base_cap = 0 â†’ floor kicks in.
    ...
    fn fee_ceiling_at_500_gwei() {
        // 100 ETH bonus â†’ enormous base â†’ ceiling kicks in.
