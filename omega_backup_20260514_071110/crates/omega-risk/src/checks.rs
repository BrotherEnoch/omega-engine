ï»¿// crates/omega-risk/src/checks.rs
//
// 13 pre-trade checks in FAST-FAIL order (spec Section 5 / S7 / S11 / S12).
//
// Order is mandatory and maps directly to the spec:
//   1.  ChainID          â€” chain_id mismatch â†’ WrongChain
//   2.  Expiry           â€” current_block â‰¥ expiry_block â†’ MissExpiry
//   3.  GasBudget        â€” total_gas > strategy max_gas_budget â†’ MissGas
//   4.  Whitelist        â€” bytecode hash not in registry â†’ MissWhitelist
//   5.  DynProfit        â€” expected_profit_net < dynamic_min_profit â†’ MissProfit
//   6.  GasSpike         â€” |Î”l1_gas_price| > 30 % since creation â†’ MissGasSpike
//   7.  OracleFreshness  â€” all oracle feeds stale â†’ MissOracle
//   8.  OracleHierarchy  â€” Chainlink+Pyth fresh but diverge >0.4% â†’ MissOracleDiverge
//   9.  Slippage         â€” slippage_bps > strategy max â†’ MissSlippage
//   10. Liquidity        â€” flashloan_available < flashloan_amountÃ—1.20 â†’ MissLiquidity
//   11. Competition      â€” competition_prob > threshold â†’ MissCompetition
//   12. RiskScore        â€” composite risk score > max_risk_score â†’ MissRisk
//   13. PriceImpact      â€” LA only: price_impact_bps > 50 â†’ MissPriceImpact
//
...
// â”€â”€â”€ Public result type â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Blueprint-like trait-object-compatible input â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
//
...
// â”€â”€â”€ Individual check implementations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/// registry) â€” NOT re-computing the hash here.  The registry is the source of truth.
#[inline]
...
///
/// Divergence above threshold = oracle manipulation signal â†’ drop with MissOracleDiverge.
...
///
/// Rule: available >= flashloan_amount Ã— 1.20 (20 % safety margin, spec S11).
/// Also enforces the no-self-flash rule: flashloan provider â‰  liquidation target protocol.
/// (e.g., no Aave-on-Aave; no Euler-on-Euler â€” spec S11.4 / crates/omega-strategies/la/protocols).
#[inline]
fn check_flashloan_liquidity(bp: &BlueprintFields, ctx: &CheckContext) -> Option<DropCode> {
    ...
    if ctx.flashloan.protocol_id.as_str() == bp.flashloan_provider_id
        && bp.strategy_id == "LA"
    {
        // Flashloan provider is the same protocol being liquidated â€” forbidden.
...
// â”€â”€â”€ Prometheus label helper â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
mod checks_tests {
    ...
    fn passing_ctx() -> CheckContext {
        CheckContext {
            ...
            oracle: OracleSnapshot {
                ...
                pyth_price:      2001.0,  // 0.05 % divergence â€” within 0.4 %
                twap_price:      1999.0,
                chainlink_age_s: 10,
                pyth_age_s:      10,
                twap_age_s:      60,
            ...
            flashloan: FlashloanSnapshot {
                available:   2_000_000,  // 2Ã— the flashloan_amount
    ...
    // â”€â”€ Check 1: chain_id â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 2: expiry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 3: gas budget â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 4: whitelist â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 5: dynamic profit â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 6: gas spike â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 7: oracle freshness â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn only_twap_fresh_passes_freshness() {
        ...
        // No divergence check when only TWAP is fresh â†’ pass check 8 too.
        assert_eq!(run_all_checks(&bp, &ctx), CheckResult::Pass);
    }

    // â”€â”€ Check 8: oracle hierarchy â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    #[test]
    fn oracle_divergence_above_0_4pct_fails_at_check_8() {
        let bp = passing_bp();
        let mut ctx = passing_ctx();
        // Chainlink 2000, Pyth 2010 â†’ divergence 0.5 % > 0.4 %
    ...
    fn single_fresh_oracle_skips_divergence_check() {
        let bp = passing_bp();
        let mut ctx = passing_ctx();
        ctx.oracle.pyth_age_s = 100; // Pyth stale â†’ only Chainlink fresh
        // Divergence check skipped; check 8 passes.
        assert_eq!(run_all_checks(&bp, &ctx), CheckResult::Pass);
    }

    // â”€â”€ Check 9: slippage â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 10: liquidity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    #[test]
    fn insufficient_flashloan_liquidity_fails_at_check_10() {
        let bp = passing_bp(); // flashloan_amount = 1_000_000
        let mut ctx = passing_ctx();
        ctx.flashloan.available = 1_100_000; // < 1_000_000 Ã— 1.20 = 1_200_000
    ...
    // â”€â”€ Check 11: competition â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 12: risk score â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Check 13: price impact (LA only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Fast-fail ordering â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
