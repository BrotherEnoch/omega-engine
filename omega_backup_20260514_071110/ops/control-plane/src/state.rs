ï»¿// ops/control-plane/src/state.rs
//
// AppState â€” single shared state for the HTTP server, gRPC server, and
...
use omega_core::{LayerId, OmegaConfig};
...
/// Structured event streamed to WebSocket clients (Â§17.1).
///
...
pub enum WsEvent {
    /// A layer's health state transitioned (Â§3).
    HealthTransition {
        layer:     String,
        from:      String,
        to:        String,
    ...
    /// The gas model pause state changed (Â§13.3).
    ModelPauseChanged {
        paused:    bool,
        timestamp: DateTime<Utc>,
    },
    /// The builder blacklist was hot-reloaded (Â§12.3).
    BlacklistReloaded {
        entry_count: usize,
        timestamp:   DateTime<Utc>,
    },
    /// The config was hot-reloaded (Â§5, L1).
    ConfigReloaded {
        timestamp: DateTime<Utc>,
    },
    /// Snapshot of the gas model ceiling escalation state (Â§13.3).
    CeilingEscalation {
...
pub struct AppState {
    ...
    // â”€â”€ Gas model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    /// Gas model checkpoint directory (Â§13.2).
    pub checkpoint_dir:  PathBuf,
    /// Whether the gas model is paused due to ceiling escalation (Â§13.3).
    pub model_paused:    AtomicBool,
    /// Ceiling escalation state for the ceiling-status API (Â§17.2).
    pub ceiling_tracker: RwLock<CeilingEscalationTracker>,

    // â”€â”€ Builder blacklist â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    /// Hot-reloadable MEV-Boost builder blacklist (Â§12.3).
    ...
    /// Shared with the propagation orchestrator â€” reads reflect live state.
    pub health_layers:   Vec<Arc<LayerHealthImpl>>,

    // â”€â”€ WebSocket broadcast â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
impl AppState {
    ...
    /// is not an error â€” the system may have no connected WS clients.
...
///
/// Returns `OmegaConfig::default()` when the file does not exist â€”
